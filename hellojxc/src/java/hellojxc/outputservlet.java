...
public class outputservlet extends HttpServlet {
    ...
    private void sendInputList_ajax(HttpServletRequest request,HttpServletResponse response)
        ...
        */
        ...
        String sql = "select a.id, b.name as goods_name, b.del_flag as del_flag, a.volume, a.price, a.buytime, a.recordtime, a.operator, a.customer_info, a.refer from jxc_output as a, jxc_goods as b where "
    ...
    private void updateoperation(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "update jxc_output set goods_id = " + "'"+goodsid +"',"
                                                        + " volume= " + volume + "," 
                                                        + " price= " + price +"," 
                                                        + " buytime= " + "'"+ buytime + "',"
    ...
    private void addoperation(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "insert into jxc_output (goods_id,volume,price,buytime,recordtime,operator,customer_info,refer) values(" 
                + "'" +  goodsid + "'," 
                +  volume + ","
                +  price  + ","
                +  "'" + operation_day + "'," 
